...
public class NeoProtectCommand implements SimpleCommand {
    ...
    public boolean hasPermission(Invocation invocation) {
        return invocation.source().hasPermission("neoprotect.admin") || (instance.getProxy().getConfiguration().isOnlineMode() && instance.getCore().isPlayerMaintainer(invocation.source() instanceof Player ? ((Player)invocation.source()).getUniqueId() : null, instance.getProxy().getConfiguration().isOnlineMode()));
    }
}
